...
Next i cleaned up the heading and footer tags by removing the <div> element that was assigned to them and grouping the <header> and <footer> tags with the respective elements inside those tags.
